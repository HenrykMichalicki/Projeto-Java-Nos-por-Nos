...
public class Regiao {
 ...
 public Regiao() {
		...
		case 1:
			System.out.println("===============================================");
			System.out.println("REGIĂO ESCOLHIDA: ZONA NORTE");
			this.norte +=read.nextInt();
			break;
		case 2:
			System.out.println("===============================================");
			System.out.println("REGIĂO ESCOLHIDA: ZONA LESTE");
			this.leste +=read.nextInt();
			break;
		case 3:
			System.out.println("===============================================");
			System.out.println("REGIĂO ESCOLHIDA: ZONA SUL");
			this.sul +=read.nextInt();
			break;
		case 4:
			System.out.println("================================================");
			System.out.println("REGIĂO ESCOLHIDA: ZONA OESTE");
			this.oeste +=read.nextInt();
			break;
		case 5:
			System.out.println("================================================");
			System.out.println("REGIĂO ESCOLHIDA: CENTRO");
